package io.java.lucid.ipldashboard.data.config;
...
import io.java.lucid.ipldashboard.data.MatchDataProcessor;
import io.java.lucid.ipldashboard.data.MatchInput;
...
public class BatchConfig {
    ...
    private final String[] FIELD_NAMES = { "id", "city", "date", "player_of_match", "venue", "neutral_venue", "team1",
            "team2", "toss_winner", "toss_decision", "winner", "result", "esult_margin", "eliminator", "method",
            "umpire1", "umpire2" };
    @Autowired
